...
let currentYear; // Declare a variable to store the currentYear globally
...
app.get('/getCourseCodes/:facultyId', (req, res) => {
    ...
    pool.query(query, (err, result) => {
      if (err) {
        ...
        // Set the currentYear based on your business logic
        // Here, I'm assuming the first batch is the current year. Modify as per your requirements.
        ...
        res.json({ facultyId, batch, courseCodes, deptcode, currentYear });
      }
    });
  });
...
app.get('/api/registerNumbers', async (req, res) => {
  // Using the globally stored currentYear
  if (!currentYear) {
